...
import { readNumber, readString } from '../../home.config';
import { distributionFor, truncatePoints } from '../../home.folding';
import { distributionOption } from '../../home.charts';
 ...
 *
 * 两个词条由这里翻好再传进去：`home.folding` 与 `home.charts` 都不认识 i18n
 * （见 §7.5：图上每个字都是服务端/用户数据，只有「未定义」与「其他」这两片是我们自己写的）。
 */
@Component({
  selector: 'home-distribution',
