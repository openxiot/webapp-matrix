...
@Component({
    selector: 'action-in-hex-value',
    templateUrl: './action.in.hex.value.component.html',
    styleUrls: ['./action.in.hex.value.component.less'],
    imports: [
        NzInputDirective
    ],
...
export class ActionInHexValueComponent {
