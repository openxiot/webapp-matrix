 ...
 * - **新建空间** —— 树里确实没有的时候才用。
 *
 * 结果不在这里落库，交给调用方（`Project3dViewComponent`）拿 `AnchorBindResult` 去写。
 */
@Component({
  selector: 'project-3d-anchor-bind',
  standalone: true,
  templateUrl: './project.3d.anchor.bind.component.html',
  styleUrl: './project.3d.anchor.bind.component.less',
