...
import { SpaceAddComponent, SpaceAddResult } from '@app/common/dialog/space/space.add.component';
...
export class ProjectTableViewComponent implements OnInit {
   ...
   *
   * 树视图（`project/tree`）在「三视图各自加载」的口径下**各拷了一份本实现**：
   * 这里 `protected` 是因为树那边要从本文件对着抄、别抄丢符号，两边语义一致。
   */
